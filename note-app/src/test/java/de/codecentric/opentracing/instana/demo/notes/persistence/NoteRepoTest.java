...
public class NoteRepoTest {
    ...
    public void whenFindById_thenReturnNoteEntity() throws Exception {
        ...
        // when
        Optional<NoteEntity> foundEntityById = noteRepo.findById(persistedEntity.getId());

        //then
        assertThat(foundEntityById.get().getNote(), is(noteMessage));
    ...
    public void whenDeleteById_thenNumberOfEntitiesIs_ZERO() throws Exception {
        ...
        // when
        noteRepo.deleteById(persistedEntity.getId());
